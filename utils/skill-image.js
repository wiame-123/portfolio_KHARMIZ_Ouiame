...
import powerbi from '../app/assets/svg/skills/power-bi.svg';
...
export const skillsImage = (skill) => {
  ...
  switch (skillID) {
    ...
    case 'fastapi':
      return fastapi;
    // Added mappings for Laravel, Symfony, and other missing skills
    // Using similar/related icons as placeholders
    case 'laravel':
      return php; // Laravel uses PHP, so using PHP icon
    case 'symfony':
      return php; // Symfony uses PHP, so using PHP icon
    case 'power bi':
      return powerbi;
    case 'ssrs':
    ...
    case 'github':
      return git; // Using Git icon for GitHub
    case 'docker':
      return docker;
    case 'python':
      return python;
    ...
    case 'css':
      return css;
    case 'latex':
      return markdown; // Using Markdown as placeholder for LaTeX
